...
module.exports = function etcdConfig(entry, opts) {
    ...
    /*
     * I think onChange should be an array that can be pushed to after the
     * fact. The nature of where etcdConfig is intaciated leaves us passing
     * callbacks from odd places.
     */
